package com.yuo.PaiMeng.Entity.Model;
...
public class CraneModel<C extends CraneEntity> extends EntityModel<C> {
     ...
     */
    public void setRotationAngles(CraneEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    public void setLivingAnimations(CraneEntity entityIn, float limbSwing, float limbSwingAmount, float partialTick) {
    ...
    public void renderOnShoulder(MatrixStack matrixStackIn, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float p_228284_5_, float p_228284_6_, float p_228284_7_, float p_228284_8_, int p_228284_9_) {
        this.setLivingAnimations(CraneModel.State.ON_SHOULDER);
        this.setRotationAngles(CraneModel.State.ON_SHOULDER, p_228284_9_, p_228284_5_, p_228284_6_, 0.0F, p_228284_7_, p_228284_8_);
        this.getParts().forEach((p_228285_4_) -> {
            p_228285_4_.render(matrixStackIn, bufferIn, packedLightIn, packedOverlayIn);
        });
    }

    private void setRotationAngles(CraneModel.State p_217162_1_, int p_217162_2_, float p_217162_3_, float p_217162_4_, float p_217162_5_, float p_217162_6_, float p_217162_7_) {
    ...
    private void setLivingAnimations(CraneModel.State p_217160_1_) {
    ...
    private static CraneModel.State getParrotState(CraneEntity p_217158_0_) {
        if (p_217158_0_.isPartying()) {
            return CraneModel.State.PARTY;
        } else if (p_217158_0_.isEntitySleeping()) {
            return CraneModel.State.SITTING;
        } else {
            return p_217158_0_.isFlying() ? CraneModel.State.FLYING : CraneModel.State.STANDING;
        }
    }
